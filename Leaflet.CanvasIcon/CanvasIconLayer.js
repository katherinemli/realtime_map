...
import { Browser, DomUtil, Layer, setOptions, Util } from "../../../../node_modules/leaflet/dist/leaflet-src.esm.js";
...
export default Layer.extend({
  ...
  removeMarker(marker, redraw) {
    ...
    // console.log(this._latlngMarkers.dirty)
    ...
    if (isDisplaying === true && redraw === true) {
      this._redraw(true);
      // console.log(this._latlngMarkers.data)
    }
  },
  ...
  clearLayers() {
    if (typeof(this._latlngMarkers) !== 'undefined') {
      this._latlngMarkers.data.children = [];
      this._latlngMarkers.total = 0;
      this._latlngMarkers.dirty = 0;
      this._markers.data.children = [];
      this._redraw(true);
    }    
  },
